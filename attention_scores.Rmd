...
Here we could follow a partial matching approach to handle unmatched GDB terms using "str_detect" function to detect for matching but with different identifiers or GBD present within a string of traits in GWAS
