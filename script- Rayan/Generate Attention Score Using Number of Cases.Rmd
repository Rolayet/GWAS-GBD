---
title: "Generate attention score using sample cases (ncase)"
...
a <- read_xlsx("/Users/rayanaloliet/Desktop/review/gwas_catalog_v1.0.2.1-studies_r2024-06-07.xlsx")
...
```{r}
h <- read_xlsx("~/Downloads/IHME_GBD_2021_A1_HIERARCHIES_Y2024M05D15.XLSX", sheet=3)
...
#gbd_daly_data <- read_csv('/Users/rayanaloliet/Desktop/10-2/after reviewing/1990/IHME-GBD_2021_DATA-113ae32d-1990.csv')
...
```{r}
broader_categories_dataset<- read_xlsx("/Users/rayanaloliet/Desktop/untitled folder 2/GBD_2021_CAUSE_HIERARCHY_Y2024M05D16.xlsx")
...
#write.csv(merged_dataset_exclude_Injuries, "merged_dataset_exclude_Injuries_.csv", row.names = FALSE)
