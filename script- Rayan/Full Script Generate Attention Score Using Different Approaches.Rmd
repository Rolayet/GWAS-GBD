...
Calculate the attention score based on the following approaches: 
...
## claen the impact factors of the journals that published gwas studies to be added as attention score 
...
## load the GBD DALY data to link the diseases to their respective burden (e.g., DALYs,)
